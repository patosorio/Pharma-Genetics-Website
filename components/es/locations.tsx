    ...
    <section id="locations" className="py-16 bg-fenopharm-gray">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-light text-white mb-4 tracking-tight">DÓNDE ENCONTRARNOS</h2>
          <p className="text-white/80 font-light">Presencia global con experiencia local</p>
        </div>
